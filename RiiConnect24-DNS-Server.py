...
print("+===============================+")
print("|    BedrockConnect EZ DNS      |")
print("|          Version " + RIICONNECT24DNSSERVER_VERSION + "          |")
print("+===============================+\n")

print("Hello! This server will allow you to use the BedrockConnect server list when your Internet Service Provider does not work with custom DNS.")

print("It can also be modified for usage in multiple DNS cases for which your ISP is blocking, as the base of EZ DNS (being the RiiConnect24 DNS Server or sudomemoDNS) is very flexible and versatile.\n")


print("#### How To Use ####\n")
print("All you have to do it set the IPs that will be shown to you below as your DNS in your device's settings.")
print("First, make sure that your device is connected to the same network as this computer.")

print("\nHere are the settings you need to type in on your device in the Internet Settings / DNS Settings section.:\n")
print(":---------------------------:")
...
print("#### Getting Help ####\n")
print("Need help? Contact IndyTheNerd#2501 on discord.com or seek help to the official BedrockConnect maintainer\n")
...
try:
  get_zones = requests.get("https://redrawn.letsjoincdm.tk/piracy/dns_zones.json")
...
print("-- Done --- \n")
print("[INFO] Starting EZ DNS.")
print("[INFO] Ready. Waiting for your device to send DNS Requests...\n")
